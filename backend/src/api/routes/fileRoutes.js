...
routers.delete('/file/delete/:idacta',checkUserRole(["admin", "oficinista"]), fileController.deleteFiles);
routers.delete('/file/deletes/:id', checkUserRole(["admin", "oficinista"]),fileController.deleteFilesS);
